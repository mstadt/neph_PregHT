# -*- coding: utf-8 -*-
"""
Created on Thu Mar 30 14:32:24 2023
...
temp = vals4[0]
temp[1] = 0 # CNT jux base to 0
jux4 = ax1.bar(full_pos+ 2*width, vals4[1], width, bottom = temp, align = 'center', edgecolor = 'k', color = 'white')
...
ax1.text(figlab_shift, ax1.get_ylim()[1], 'A1', size=fig_lab_size, weight='bold')
...
ax2.text(figlab_shift, ax2.get_ylim()[1], 'B1', size=fig_lab_size, weight='bold')
...
direct4 = 'HKAKOpreg-MP_Apr3'
sex4 = 'midpregnant'

direct5 = 'latepregnant_rat'
sex5 = 'latepregnant'

direct6 = 'HKAKOpreg-LP_Apr3'
sex6 = 'latepregnant'
...
label2 = 'HKA KO virgin'
label3 = 'Baseline MP'
label4 = 'HKA KO pregnancy-specific MP'
label5 = 'Baseline LP'
label6 = 'HKA KO pregnancy-specific LP'
...
sup2 = ax1.bar(full_pos, vals2[0], width, align = 'center', edgecolor = 'k', color = c2, label = label2)
temp = vals2[0]
jux2 = ax1.bar(full_pos, vals2[1], width, bottom = temp, align = 'center', edgecolor = 'k', color = 'white')
...
ax1.legend(fontsize=leg_size)
ax1.set_ylim(-2.0,5.3)
ax1.text(figlab_shift, ax1.get_ylim()[1], 'A2', size=fig_lab_size, weight='bold')
...
sup3 = ax2.bar(full_pos+width, vals3[0], width, align = 'center', edgecolor = 'k', color = c3, label = label3)
temp = vals3[0]
jux3 = ax2.bar(full_pos+width, vals3[1], width, bottom = temp, align = 'center', edgecolor = 'k', color = 'white')
...
ax2.legend(fontsize=leg_size)
ax2.set_ylim(-0.6,1.7)
ax2.text(figlab_shift, ax2.get_ylim()[1], 'B2', size=fig_lab_size, weight='bold')
